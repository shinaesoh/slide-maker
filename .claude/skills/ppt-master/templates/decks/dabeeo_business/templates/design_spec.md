...
> | 파랑 | `#214DC5` | `#1E57DC` |
> | 구조색 | `#112662` · `#253062` | `#192A67` |
> | 출처 | 실제 제안서에서 추출된 것으로 보임 | 사내 디자인 자료 `:root` 토큰 + 제품 토큰 (일치) |
>
> **둘 중 어느 쪽이 전사 CI인지는 확정되지 않았습니다.** 디자인 담당자 확인 전까지 통합하지 않고
> 용도로 분리해 둡니다. 이 덱을 고르면 SKILL.md Step 4 reconciliation에 따라 이 스킨이
> 브랜드 프리셋의 색을 덮어쓰므로, 한 덱 안에서 두 기준이 섞이지는 않습니다.
>
> 기업소개 덱이 아닌 일반 제안서·보고서에는 `brands/dabeeo` 프리셋을 쓰세요.
